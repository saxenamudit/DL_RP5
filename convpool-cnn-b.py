...
#   (conv3): Conv2d(96, 96, kernel_size=(1, 1), stride=(1, 1), padding=(1, 1))
...
#   (conv5): Conv2d(192, 192, kernel_size=(5, 5), stride=(1, 1), padding=(1, 1))
#   (conv6): Conv2d(192, 192, kernel_size=(1, 1), stride=(1, 1), padding=(1, 1))
...
class AllConvNet(nn.Module):
    def __init__(self, input_size, n_classes=10, **kwargs):
        ...
        self.conv2 = nn.Conv2d(96, 96, 5, padding=1)
        self.conv3 = nn.Conv2d(96, 96, 1, padding=1)
